  ...
  <header>
    ...
    <div class="video-container">
      <video autoplay muted loop class="background-video">
        <source src="image/home/video1.mp4" type="video/mp4">
      ...
      <div class="content">
        ...
        <a href="../../luhith/login/index.php"><button class="reserve-button">Reserve Your Parking space</button></a>
      </div>
    </div>
    <div class="middle-content">
      ...
      <div class="packages-more">
        <a href="../../luhith/login/index.php"><button>See More Packages</button></a>
      </div>
