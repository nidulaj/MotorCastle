...
<head>
    ...
    <link rel="stylesheet" href="employeeCss/manageEmployee.css">
          ...
          <div class="content">
            ...
            <div class="employeeForm">
                ...
                <div class = "manageEmployee">
                  ...
                  <img src = "images\employeeManagement.png" alt = "Employee Image" width="250px">
                  <button onclick="window.location.href='employeeSignupForm.php'">Add Employee</button>
                  <button onclick="window.location.href='read.php'">View Employees</button>
                  <button onclick="window.location.href='updateForm.php'">Update Employee</button>
                  <button onclick="window.location.href='deleteForm.php'">Delete Employee</button>
                </div>
                <center>
