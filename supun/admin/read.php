...
<head>
    ...
    <link rel="stylesheet" href="employeeCss/employeeTable.css">
        ...
        <div class="main">
            ...
            <div class="content">
                <?php
                    ...
                    $sqlRead = "SELECT Id, Name, Contact_no, Email,DOB, Gender, Address, Username, Password, Confirmed_Password FROM employee";

                    $result = $con->query($sqlRead);
                    
                    if ($result->num_rows > 0) 
                    {
                        echo "<div style='padding: 10px; color:white; '>Employee Data</div>";
                        echo "<div class = 'employeeTable'>";
                            echo "<table border='1'>";
                            echo "<tr><th>Id</th><th>Name</th><th>Contact No</th><th>Email</th><th>DOB</th><th>Gender</th><th>Address</th><th>Username</th><th>Password</th><th>Confirmed Password</th></tr>"; // Header row
                    ...
                    {
                        echo "<div class='employeeForm'>No results</div>";
                    }
