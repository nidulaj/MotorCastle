          ...
          <div class="content">
            ...
            <div class="employeeForm">
                    <fieldset class="fieldset">  
                        <legend class = "legend"><b>Remove an employee</b></legend>
                        <form method = "POST" action = "delete.php" class ="form">
                            ...
                            <div class = "formButtons">
                              <input type ="submit" value = "Delete data" class="submitButton" > <input type = "reset"  value = "Reset" class = "resetButton">
                            </div>
