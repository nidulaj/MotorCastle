...
<body>
          ...
          <div class="content">
            ...
            <div class="employeeForm">
                    <fieldset class="fieldset">  
                        <legend class = "legend"><b>Update an Employee Account</b></legend>
                        <form method = "POST" action = "update.php" class ="form" onsubmit="return validatePasswords();">

                            Employee ID <br> <input type = "text" size = "20" name = "eId" class="inputField" required><br><br>
                            Name <br> <input type = "text" size = "26" name = "eName" class="inputField" required><br><br>
                            Contact No <br> <input type = "text" size = "10" name = "eContact" class="inputField" required><br><br>
                            ...
                            <div class = "formButtons">
                              <input type ="submit" value = "Update" class="submitButton" > <input type = "reset"  value = "Reset" class = "resetButton">
                            </div>
    ...
    <script src="employeeJs/validatePasswords.js"></script>
</body>
