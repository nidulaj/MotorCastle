...
<head>
    ...
    <title>Employee update confirmation</title>
          ...
          <div class="content">
            ...
            <div class="employeeForm">
                ...
                <?php
                    ...
                    if (empty($empName)||empty($empContact)|| empty($empEmail) )
                    {
                        echo "Need to fill all data";
                    }

                    else
                    {
                        $sqlUpdate = "UPDATE employee SET Name = '$empName', Contact_no = '$empContact', Email = '$empEmail', DOB = '$empBirthday', Gender = '$empGender', Address = '$empAddress', Username = '$empusername', `Password` = '$empPassword', `Confirmed_Password` = '$empConfirmPassword' WHERE Id = '$empId'";

                        if ($con -> query($sqlUpdate))
                        {
                            echo "Updated the table.";
                        }
                        else
                        {
                            echo "Update failed.";
