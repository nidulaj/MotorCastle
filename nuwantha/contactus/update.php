...
$uMessage = $_POST["message"];
    ...
    $sql = "UPDATE inquiry SET uname='$usName', email='$uemail', message='$uMessage' WHERE id='$inqID'";
    ...
    if ($con->query($sql)) {
        echo '<head>
                  ...
                  <div class="feedback">
                    <div class="feedback-msg"> 
                      Inquiry Update Successful!
                    </div>
                    <a href="contact.php"><button>Back to Dashboard</button></a>
                    <a href="read.php"><button>View updated Inquiry</button></a>
                  </div>
                  <footer class="footer">
        ...
        echo '<head>
                  ...
                  <link rel="stylesheet" href="../css/header.css" />
                  <link rel="stylesheet" href="../css/footer.css" />
                  <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css"><link rel="stylesheet" href="update-feedback.css" />
                  </head>
                  <body>
                  <header>
                    <?php include("../../luhith/components/header2.php") ?>
                  ...
                  <div class="feedback">
                    <div class="feedback-msg"> 
                      Inquiry Update Unsuccessful!
                    </div>
                    <a href="up-index.php"><button>Back to Dashboard</button></a>
