...
<header>
    ...
    <div class="container">
        <h2>Contact us| Delete an Inquiry</h2>
        <div class="contact-wrapper">
            <div class="contact-form">
                <h3>Send us a message</h3>
                <form id="contactForm" method="post" action="delete.php">
                    <div class="form-group">
                       <input type="number" id="id" name="iid" placeholder="Enter a valid Inquiry ID" required>
                    </div>
